---
title: "Project Plan Instructions"
author: project
date: 2026-03-23
status: draft
---
...
5. Suggestions for improvements when asked.
6. Versioned feature planning.

Every time I ask for changes or new features:
- You should look at existing files.
- You should consider the current architecture.
- You should add comments explaining the changes.
- You should always keep backward compatibility if possible.

Project Context:
- It is a personal money management and financial analytics system.
- It tracks monthly income, expenses, savings, profit, and item analysis.
